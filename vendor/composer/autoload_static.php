...
class ComposerStaticInite3bd81636dc7ff42b75ca5377feeeea3
{
    ...
    public static $prefixDirsPsr4 = array (
        'load\\' => 
        array (
            0 => __DIR__ . '/../..' . '/homework-7',
        ),
    );

    public static $classMap = array (
        'Composer\\InstalledVersions' => __DIR__ . '/..' . '/composer/InstalledVersions.php',
        'load\\BaseClass' => __DIR__ . '/../..' . '/homework-7/BaseClass.php',
        'load\\ParentClass' => __DIR__ . '/../..' . '/homework-7/ParentClass.php',
        'load\\ParentClassTwoo' => __DIR__ . '/../..' . '/homework-7/ParentClassTwoo.php',
    );
